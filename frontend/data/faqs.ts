...
export const GLOBAL_FAQS: Faq[] = [
  ...
  },
  {
    ...
    answerAr:
      'نعم، كل تركيباتنا تستخدم بيكتين نباتي بدلًا من الجيلاتين الحيواني. المنتج نباتي بالكامل ماعدا حبّة نضرة التي تحتوي على كولاجين بحري.',
    category: 'product',
  },
  {
    id: 'faq-04',
  ...
  },
  {
    ...
    answerAr:
      'نعم، يمكن الجمع. عميلاتنا كثيرًا تأخذ نضرة مع جذر في الصباح. بريق مع نضرة تعطي فائدة مضاعفة — تفتيح وبناء للبشرة من كل الزوايا.',
    category: 'product',
  },
  {
    id: 'faq-06',
