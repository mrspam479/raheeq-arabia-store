...
export const PRODUCTS: Product[] = [
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    shortDescriptionAr:
      'تصحين ووجهكِ باهت، الخطوط حول العين والفم أوضح، والمكياج بدل ما يخفيها يعلّق فيها. المشكلة غالبًا مو كريم ناقص — بشرتكِ تحتاج دعم من الداخل لأن الكولاجين يقل مع الوقت.',

    longDescriptionAr:
      'نضرة هي روتينكِ اليومي للبشرة من الداخل: كولاجين بحري يدعم مرونة البشرة، أستازانتين يحارب الإجهاد التأكسدي، وفيتامين سي يساعد تكوين الكولاجين الطبيعي. حبّتين بعد الفطور. خلال ٤ أسابيع غالبًا تلاحظين نعومة ونضارة، ومع الاستمرار ٨-١٢ أسبوع تبدأ النتيجة تبان أكثر في المرآة والصور.',
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    shortDescriptionAr:
      'كل صباح نفس الدائرة: كونسيلر تحت العين، نظرة مرهقة، وسؤال يضايقكِ: "تعبانة؟" إذا الهالات ما راحت مع النوم، المشكلة غالبًا أعمق من السهر — تحتاجين دعم للدم والأكسجين من الداخل.',

    longDescriptionAr:
      'بريق مصممة للهالات المرتبطة بالإرهاق ونقص الحديد: حديد bisglycinate خفيف على المعدة، حمض فوليك، وفيتامين سي لتحسين الامتصاص. كبسولتين بعد الفطور. خلال ٤-٦ أسابيع غالبًا يبان فرق بسيط، ومع ٨ أسابيع تبدأين تشوفين وجهكِ أفتح وأقل تعبًا بدون الاعتماد اليومي على الكونسيلر.',
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    shortDescriptionAr:
      'شعر على المخدة، شعر بالمشط، وخصل في يدكِ بعد الاستحمام. تبدئين تغيّرين تسريحتكِ عشان تخفين الفراغات. الزيوت تلمّع الشعر من برا، بس الجذر نفسه يحتاج تغذية من الداخل.',

    longDescriptionAr:
      'جذر تدعم الشعر من المكان الصح: الداخل. بيوتين يساعد الحفاظ على الشعر الطبيعي، كولاجين وكيراتين يدعمون القوة واللمعان. حبّتين بعد الفطور. التساقط يحتاج صبر: غالبًا تلاحظين طيح أقل خلال ٦-٨ أسابيع، والكثافة تحتاج ٩٠ يوم لأن دورة نمو الشعر بطيئة.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answerAr:
          'لأن جذر ليست بيوتين فقط. فيها بيوتين + كولاجين + كيراتين، يعني دعم للشعر من ناحية الجذر والقوة واللمعان في نفس الروتين.',
      },
      {
        questionAr: 'هل فيها جيلاتين؟',
        answerAr:
    ...
    seo: {
      ...
      descriptionAr:
        'بيوتين + كولاجين + كيراتين لدعم الشعر من الداخل. روتين يومي واضح، دفع عند الاستلام، وضمان ٣٠ يوم.',
    },
  },
...
export const PRODUCT_BENEFITS: Record<string, { icon: string; text: string }[]> = {
  'habba-nadra': [
    { icon: '✨', text: 'نضارة أوضح خلال شهر' },
    { icon: '💧', text: 'مرونة وترطيب داخلي' },
    { icon: '🌟', text: 'مظهر أهدأ بالصور' },
  ],
  'habba-bareeq': [
    { icon: '👁️', text: 'نظرة أقل تعبًا' },
    { icon: '💪', text: 'حديد خفيف الامتصاص' },
...
export const PRODUCT_BEFORE_AFTER: Record<string, { before: string[]; after: string[] }> = {
  ...
  'bundle-glow-trio': {
    before: [
      'بشرة باهتة، هالات، وتساقط… وكل مشكلة تسحب ثقتكِ من جهة',
      'تحتارين: أبدأ بالبشرة؟ الهالات؟ الشعر؟',
      'تشترين منتج واحد وتبقين تحسين إن الروتين ناقص',
    ],
    after: [
      'نفس المنتجات الثلاثة تصل مع بعض في طلب واحد واضح',
      'نضرة للبشرة + بريق للهالات + جذر للشعر',
