...
export const PRODUCTS: Product[] = [
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    heroTagAr: 'كل مرة تضحكين، خطوط وجهكِ تذكركِ إن بشرتكِ كبرت؟',

    shortDescriptionAr:
      'تحاولين تخفينها بالمكياج، بس الطبقات تزيد المشكلة وتبين التجاعيد أعمق. الكريمات الغالية تبقى على السطح، والوقت يمر وبشرتكِ تفقد مرونتها أكثر كل يوم. الإحساس بأنكِ تفقدين نضارتكِ وشبابكِ مزعج ومؤلم نفسياً.',

    longDescriptionAr:
      'بعد سن ٢٥، بشرتكِ تفقد الكولاجين كل سنة. الكريمات ما تعوّض هذا — جزيئاتها كبيرة ما تدخل الجلد. نضرة تعمل من الداخل: أستازانتين يحمي خلايا بشرتكِ من الشمس والتأكسد، وكولاجين بحري يبني كولاجين جديد. حبّتين بالصباح — وخلال شهر تلاحظين الفرق: خطوط أقل، إشراقة أكثر، وبشرة ممتلئة.',
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    heroTagAr: 'تعبتي من سؤال "شكلك تعبانة اليوم؟" وأنتِ أصلاً نايمة زين؟',

    shortDescriptionAr:
      'مهما نمتي وارتحتي، السواد تحت عينكِ يخليكِ تبينين مرهقة وأكبر من عمركِ. الكونسيلر صار روتين يومي إجباري حتى لو بالبيت، والزيوت ما سوت شيء لأن المشكلة مو في قلة النوم، المشكلة في نقص الحديد اللي خانق بشرتكِ.',

    longDescriptionAr:
      'الهالات مش مشكلة نوم. هي مشكلة نقص حديد — الدم ما يوصل أكسجين كافي للبشرة الرقيقة تحت العين فيبان السواد. بريق فيها حديد سهل الامتصاص (bisglycinate) + حمض الفوليك اللي يبني خلايا دم حمراء جديدة. كبسولتين بالصباح — وخلال شهر يبدأ اللون يتحسّن وترجعلكِ إشراقتكِ الطبيعية بدون كونسيلر.',
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    heroTagAr: 'كل ما تتروشين تشوفين خصل شعركِ تطيح وتخافين من الفراغات؟',

    shortDescriptionAr:
      'تجمعين الشعر اللي يطيح على المخدة وبالمشط وأنتِ مقهورة. جربتي زيوت وشامبوهات غالية بس التساقط مستمر والفراغات بدأت توضح. الخوف من إن شعركِ يفقد كثافته بالكامل يخليكِ تفكرين ألف مرة قبل تسرحينه أو تطلعين للناس.',

    longDescriptionAr:
      'الشعر يحتاج بناء من الداخل — الزيوت والكريمات ما توصل للجذر. جذر تغذّي شعركِ من الداخل بحلوى توت لذيذة. بيوتين بجرعة عالية يبني الكيراتين (البروتين الأساسي في شعركِ) + كولاجين يقوّي البصيلة ويمنع التقصّف. العلبة فيها ٩٠ حبة (تكفي شهر ونصف)، حبّتين بالصباح وبعد شهرين تلاحظين كثافة واضحة وتساقط أقل.',
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    heroTagAr: 'تعبتي من الترقيع؟ بشرة باهتة، هالات واضحة، وشعر يتساقط؟',

    shortDescriptionAr:
      'الكريمات الخارجية والزيوت ما تحل المشكلة من جذورها. لما يتساقط شعركِ، وتظهر الهالات السوداء، وتفقد بشرتكِ نضارتها، هذا إنذار من جسمكِ إنه يفتقد للفيتامينات والمعادن الأساسية. لا تضيعين فلوسكِ على حلول سطحية ومؤقتة.',

    longDescriptionAr:
      'جمالكِ ما يتجزأ. هذا الصندوق هو الحل الجذري والنهائي اللي يعالج مشاكلكِ الثلاثة معاً من الداخل. حبّة نضرة (لبشرة مشدودة بدون تجاعيد) + حبّة بريق (لمسح الهالات السوداء وإعادة الإشراقة) + حبّة جذر (لإيقاف التساقط وتكثيف الشعر). روتين واحد يومي بعد الفطور يعيد لكِ ثقتكِ بنفسكِ خلال ٦٠ يوم. وبدل ما تدفعين ٥٩٧ ريال، تاخذينهم كلهم بـ ٤٩٩ ريال فقط.',
...
export const PRODUCT_TIMELINE: Record<string, { when: string; result: string }[]> = {
  'habba-nadra': [
    ...
    { when: 'الأسبوع ٢', result: 'خطوط أقل' },
    { when: 'الشهر ١', result: 'بشرة تلمع' },
    { when: 'الشهر ٢', result: 'نتيجة كاملة' },
  ],
  'habba-bareeq': [
    { when: 'الأسبوع ١', result: 'بشرة منتعشة' },
    { when: 'الأسبوع ٢', result: 'هالات أفتح قليلًا' },
    { when: 'الشهر ١', result: 'فرق واضح بالصور' },
    { when: 'الشهر ٢', result: 'نتيجة كاملة' },
  ],
  'habba-jathr': [
    { when: 'الأسبوع ٢', result: 'تساقط أقل' },
    { when: 'الشهر ١', result: 'بداية الكثافة' },
    { when: 'الشهر ٢', result: 'شعر أقوى وألمع' },
    { when: 'الشهر ٣', result: 'نتيجة كاملة' },
  ],
  'bundle-glow-trio': [
    { when: 'الأسبوع ١', result: 'ترطيب وانتعاش' },
    { when: 'الأسبوع ٢', result: 'هالات أفتح + تساقط أقل' },
    { when: 'الشهر ١', result: 'بشرة تلمع + شعر يكثف' },
    { when: 'الشهر ٢', result: 'تحوّل شامل' },
  ],
};
...
export const PRODUCT_WHY_BODY: Record<string, string> = {
  ...
  'habba-bareeq':
    'الهالات مو بس قلة نوم، سببها الأكبر نقص الحديد وتراكم الميلانين! أغلب المنتجات الثانية تعطيك وعود فاضية. بريق تهاجم السواد من 3 جهات: فيتامين سي يفتح، والحديد يرفع الأكسجين، والنياسيناميد يوقف التصبغ.',
  'habba-jathr':
    'الزيوت والشامبوهات حدها من برة بس، بس جذر تغذي البصيلة نفسها من جوا! فيها مستخلص تفاح إيطالي رجّع الكثافة لـ 250 وحدة بالدراسات. مع بيوتين وزنك وفيتامين د3 وحمض فوليك.. شعرك راح يتنفس من جديد.',
};
