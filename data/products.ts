...
export const PRODUCTS: Product[] = [
  ...
  ══════════════════════════════════════════════════════════ */
  {
    ...
    heroTagAr: 'بشرة باهتة، هالات تفضح تعبكِ، وشعر يطيح كل يوم؟',

    shortDescriptionAr:
      'تدفعين مبالغ خيالية على كريمات للوجه، وسيرومات للهالات، وزيوت للشعر، وكلها حلول سطحية ومؤقتة ترجعك لنفس نقطة البداية. الدوامة هذي تستنزف فلوسكِ وثقتكِ بنفسكِ كل يوم وأنتِ تشوفين ملامحكِ تتعب.',

    longDescriptionAr:
      'الـ 3 منتجات اللي تحتاجينها لجمالكِ الكامل، في صندوق واحد. بدل ما تطلبين كل منتج بـ 199 ريال (المجموع 597)، خذي الصندوق الكامل بـ 499 ريال. حبّة نضرة لبشرتكِ + حبّة بريق لهالاتكِ + حبّة جذر لشعركِ — كل شيء يشتغل سوا لمدة شهر كامل من الداخل للنتيجة الأكفى.',
