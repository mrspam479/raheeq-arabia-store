...
export const NAV = {
  ...
  CONTACT: 'تواصلي معنا',
  CART: 'السلّة',
  ANNOUNCEMENT_BAR: 'شحن داخل المملكة في ١–٣ أيام · دفع عند الاستلام · ضمان ٣٠ يوم',
} as const;
...
export const ANNOUNCEMENT_BAR = [
  ...
  'ضمان ٣٠ يوم كامل · نختبر كل دفعة مخبريًا',
  'طلب ٣ علب = الأفضل قيمةً — وفّري حتى ٢٤٨ ر.س',
] as const;

export const HOME = {
  HERO: {
    EYEBROW: 'صيدلية الجمال السعودية',
    HEADLINE: 'حلوى يومية تُغنيكِ عن ١٠ مكمّلات.',
    SUBHEADLINE:
      'علكات الأستازانثين، التوت البري، والجلوتاثيون — تركيبات سريرية بجرعات مدروسة، بطعم حلوى، وبأمانٍ مختبري.',
    CTA_PRIMARY: 'استكشفي العلكات السريرية',
    CTA_SECONDARY: 'عن رحيق ←',
  },
  TRUST_STRIP: [
    'الدفع عند الاستلام',
    'شحن ١–٣ أيام',
  ...
  WHY: {
    HEADING: 'صيدلية، مو متجر تجميل',
    COLS: [
      { title: 'تركيبات سريرية', body: 'كل مكوّن بجرعة مدروسة بناءً على أبحاث منشورة. نشرح لكِ المصدر والجرعة — بدون مكونات سرية.' },
      { title: 'فحص مخبري', body: 'تُغلَّف في السعودية بمعايير GMP، وتمرّ بفحص استقرار قبل أن تصلكِ.' },
      { title: 'ريتوال يومي', body: 'حبّتان في اليوم — روتين طبي يذكّركِ إنّكِ الأولى.' },
    ],
  },
  PRODUCTS_ROW: {
    HEADING: 'العلكات السريرية',
    SUB: 'كل تركيبة بجرعة مدروسة لهدف واحد — ومُصاغة لتكون يومًا لذيذًا.',
  },
  RITUAL: {
    HEADING: 'جمالك يستحق علم، مو وعود.',
  ...
  CLOSING_CTA: {
    EYEBROW: 'ابدئي روتينكِ السريري اليوم',
...
export const CHECKOUT = {
  ...
  TRUST_ROW: 'شحن آمن · ضمان ٣٠ يوم · فريق سعودي',
} as const;
...
export const COLLECTION = {
  HERO: {
    ...
    H1: 'ثلاث علكات. ثلاث مشاكل. حلّ سريري واحد.',
    SUB: 'اختاري العلكة التي تليق بأهدافكِ. كلّها مرخّصة من SFDA.',
  },
  COMBO: {
    HEADING: 'الروتين السريري المتكامل',
    SUB: 'أستازانثين + توت بري + جلوتاثيون — لروتين جمال شامل.',
...
— مؤسِّسة رحيق`,
  PILLARS: [
    ...
    { title: 'وعد واضح', body: 'ضمان ٣٠ يوم كامل — والدفع عند الاستلام دائمًا.' },
  ],
...
export const GLOBAL_FAQS = [
  ...
  },
  {
    ...
    a: 'ضمان ٣٠ يوم كامل — لو ما عجبكِ نرجّع فلوسكِ بدون أسئلة.',
  },
] as const;
...
export const COPY = {
  ...
  HOME: {
    ...
    PRODUCTS_HEADING: 'اختاري العلكة — كلٌّ لها قصّة.',
    PRODUCTS_SUBHEADING: HOME.PRODUCTS_ROW.SUB,
    FROM_PRICE: 'من {price} ر.س',
    HOW_HEADING: HOME.RITUAL.HEADING,
    HOW_STEPS: [
      { title: 'اختاري', body: 'أستازانثين للتجاعيد، توت بري للهالات، أو جلوتاثيون للنضارة — أو الثلاثة.' },
    ...
    FINAL_CTA_BODY: 'حبّتان في اليوم — روتين سريري يعتني بكِ من الداخل.',
